...
return [
    ...
    'redirect_source_url' => 'Enter the URL you want to redirect from. Use `*` as a wildcard to match any characters (e.g. `/blog/2026/*`).',
    'redirect_destination_url' => 'Enter the destination URL. For wildcard redirects, use `$1`, `$2`, etc. to reference captured segments (e.g. `/articles/$1`).',
