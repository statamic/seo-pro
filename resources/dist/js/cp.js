  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "p-0" }, [
        _c("h1", { staticClass: "p-6 bg-grey-20 border-b" }, [
          _vm._v(
            "\n            " +
        ...
        _c(
          "div",
          { staticClass: "p-6 -mb-4" },
          _vm._l(_vm.item.results, function(item) {
            return _c("div", { staticClass: "flex mb-4 leading-normal" }, [
              _c("div", [
                _c("span", {
        ...
        _c(
          ...
          {
            staticClass:
              "p-4 pl-6 bg-grey-20 border-t text-left font-mono text-grey-60 text-xs"
          },
          [_vm._v("\n            " + _vm._s(_vm.item.url) + "\n        ")]
        )
      ])
    ...
    _vm.loading
      ...
      ? _c("div", [
          _c(
            ...
            {
              staticClass:
                "card mb-4 text-sm text-grey flex items-center justify-between"
            },
            [
              _c(
                "div",
          ...
          _vm._v(" "),
          _c("div", { staticClass: "card p-0 mb-4" }, [
            _c("table", { staticClass: "data-table" }, [
              _c(
                "tbody",
                ...
                _vm._l(_vm.report.pages, function(item) {
                  return _c("tr", [
                    ...
                    _c(
                      ...
                      [
                        _c("a", {
                          staticClass: "text-grey-60 mr-4 hover:text-grey-80",
                        ...
                        item.edit_url
                          ? _c("a", {
                              staticClass:
                                "mr-4 text-grey-60 hover:text-grey-80",
  ...
  return _c(
    ...
    [
      ...
      _vm.reports.length === 0 && !_vm.loading
        ? _c("div", { staticClass: "no-results md:pt-30 max-w-2xl mx-auto" }, [
            _c("div", { staticClass: "flex flex-wrap" }, [
              _c("div", { staticClass: "w-full md:w-1/2" }, [
                ...
                _c("p", {
                  staticClass:
                    "text-grey-70 leading-normal mb-8 text-lg antialiased",
                  domProps: {
                    textContent: _vm._s(
              ...
              _vm._v(" "),
              _c("div", { staticClass: "hidden md:block w-1/2 pl-16" }, [
                _c(
                  "svg",
                  {
                    attrs: {
...
module.exports = __webpack_require__(/*! /Users/jesseleite/Code/Wilderborn/seo-pro/resources/js/cp.js */"./resources/js/cp.js");
