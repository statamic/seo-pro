...
<template>
    <div class="flex flex-col md:flex-row @live-preview:flex-col md:items-center gap-2 border border-gray-200 rounded-md p-2 bg-gray-50 dark:bg-gray-900 dark:border-gray-800">
        <div class="w-32">
            <Select
	            class="w-full"
